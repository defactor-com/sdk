...
import { BaseContract, CoreContract } from '../src'
...
export const ADMIN_POOLS_ETH_ADDRESS =
  '0xc9BB84fCE54C27C159Cbef4cb45A922018cFF675'
...
export const SECOND_TESTING_PRIVATE_KEY =
  '0x0FEEe8332394aDc9eB439020DD8D38f4F93999Bd'
...
export const approveTokenAmount = async (
  contract: Erc20,
  provider: SelfProvider<CoreContract>,
  amount: bigint
) => {
...
export const setPause = async (
  provider: SelfProvider<BaseContract>,
  value: boolean
) => {
